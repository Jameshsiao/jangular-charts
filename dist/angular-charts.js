     ...
     */
      function barChart() {
        function make_y_axis() {
          return d3.svg.axis().scale(y).orient('left').ticks(4);
        }
        /**
       ...
       */
        ...
        filterXAxis(xAxis, x);
        var yAxis = d3.svg.axis().scale(y).orient('left').ticks(8).tickFormat(d3.format('s'));
        /**
       ...
       */
        ...
        bars.attr('width', x0.rangeBand() * .7);
...
angular.module('angularChartsTemplates', ['angularChartsTemplate_left', 'angularChartsTemplate_right', 'angularChartsTemplate_bottom']);
...
angular.module("angularChartsTemplate_bottom", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("angularChartsTemplate_bottom",
    "<div class=\"angular-charts-template legend-bottom\"><div class=\"ac-title\">{{acConfig.title}}</div><div class=\"ac-chart\"></div><div class=\"ac-legend\" ng-show=\"{{acConfig.legend.display}}\"><table><tr><td ng-repeat=\"l in legends | limitTo:yMaxData\"><div class=\"ac-legend-box\" ng-attr-style=\"background:{{l.color}};\"></div><div ng-bind-html=\"l.title\"></td></tr></table></div></div>");
}]);
